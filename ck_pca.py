...
df = pd.read_csv("C:/Users/red/Desktop/MachineLearning/GB_metal_dataset/RGBTexXY_comma.csv")
...
Xarr = X.values
yarr = y.values
#X=list(Xdf.itertuples(index=False, name=None))
#y=list(ydf.itertuples(index=False, name=None))
#X, y = load_svmlight_file("C:/Users/red/Downloads/WinPython-64bit-3.6.3.0Qt5/MachineLearning/GB_metal_avgRGB_lightsvmformat.txt")
